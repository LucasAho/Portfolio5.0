    ...
    return (
        <Box sx={{ overflow: "auto" }}>
            <Box sx={{ width: "100%", display: "table", tableLayout: "fixed" }}>
                <Typography align='center' variant='h1'>Voice of Stone</Typography>
                <Typography align='center' variant='h2'>A Guide on Proto-Tukren</Typography>
                ...
                <Container className='tukren-phonology'>
                    <Typography variant='h2'>Phonology</Typography>
                    ...
                    <Typography variant='h3'>Phonemes</Typography>
                    <PhonemeTables />
                    <Typography mt={2} mb={0} variant='h4'>Dipthongs</Typography>
                    ...
                    <Typography variant='h4'>Phonotactics</Typography>
                    <Typography variant='h5'>Syllable Shape</Typography>
                    <Typography variant='body1'>(C)V(C)(C)</Typography>
                    <Typography mt={1} variant='h6'>Rules & Exception</Typography>
                    <ul style={{ marginTop: 0 }}>
                        <li>Phonemes -y, -h, -w will never occur in the syllable coda.</li>
                        <li>A syllable must have an onset if it has a coda.</li>
                    </ul>
                    <Typography variant='h5'>Phonemic Stress</Typography>
                ...
                <Container className='tukren-syntax'>
                    ...
                    <Typography my={1} variant='h4'>Word Order</Typography>
                    ...
                    <Typography mt={1} variant='h4'>Adposition</Typography>
                    ...
                    <Typography mt={1} variant='h4'>Possession</Typography>
                    ...
                    <Typography mt={1} variant='h4'>Adverbs</Typography>
                    ...
                    <Typography my={1} variant='h4'>Conjunctions</Typography>
                ...
                <Container className='tukren-morphology'>
                    <Typography variant='h3'>Morphology</Typography>
                    <Typography my={1} variant='h4'>Noun Morphology</Typography>
                    ...
                    <ArticleTable />
                    <Typography mt={2} variant='h5'>Pronouns</Typography>
                    ...
                    <PronounTable />
                    <Typography mt={1} variant='h5'>Determiners</Typography>
                    ...
                    <Typography variant='h5'>Interrogatives</Typography>
                    ...
                    <Typography mt={2} variant='h5'>Affixes</Typography>
                    <Typography variant='body1'>
                    ...
                    <Typography my={1} variant='h4'>Verb Morphology</Typography>
                    <Typography variant='h5'>Verb Tense</Typography>
                    <Typography variant='body1'>Tukren follows verbs with deictic particles, to denote the verb's aspect and tense. It separates into three aspects: Perfective, Imperfective, and Habitual. </Typography>
                    <ul>
                        <li>Perfective: denotes actions that occur in completion</li>
                        <li>Imperfective: denotes actions that are in progress or incomplete</li>
                        <li>Habitual: denotes actions that are implied to have been repeated on a regular basis</li>
                    </ul>
                    <Typography variant='body1'>As a consequence of their isolationist and conservative dispositions, the language of the Rohīren takes special care to denote a verb's tense. Verb tense can be sorted into 6 different categories:</Typography>
                    <ul>
                        <li>Colony Past: Long before the speaker's lifetime</li>
                        <li>Lifetime Past: Regarding an action that occurred within the speaker's lifetime</li>
                        <li>Past: An action recently passed</li>
                        <li>Present: Verbs in the present tense are not modified.</li>
                        <li>Future: An action that will occur within the speaker's lifetime</li>
                        <li>Colony Future: Regarding an event that will likely not take place for many generations</li>
                    </ul>
                    <VerbTense />
                    <Typography mt={1} variant='h5'>Examples</Typography>
                    <Grid mb={1} container>
                        <Grid item sm={4}>
                            <Typography variant='h6'>Recent Past Perfective</Typography>
                        ...
                        <Grid item sm={4}>
                            <Typography variant='h6'>Future Imperfective</Typography>
                        ...
                        <Grid item sm={4}>
                            <Typography variant='h6'>Colony Past Habitual</Typography>
                    ...
                    <Typography variant='h5'>Linking Verbs</Typography>
                    <Typography variant='body1'>A linking verb links the subject of a sentence to its subject complement. This is used to describe or re-identify the noun. In Tukren, there are three linking verbs: tec for first person, doc for second person, and yen for third person.</Typography>
                    <Typography mt={1} variant='h5'>Examples</Typography>
                    <Grid mb={1} container>

                        <Grid item sm={4}>
                            <Typography variant='h6'>First Person</Typography>
                            <Typography variant='body1'>I am strong</Typography>
                            <Typography variant='body1'>Y falmen tec</Typography>
                        </Grid>
                        <Grid item sm={4}>
                            <Typography variant='h6'>Second Person</Typography>
                            <Typography variant='body1'>You are strong</Typography>
                            <Typography variant='body1'>Bos falmen doc</Typography>
                        </Grid>
                        <Grid item sm={4}>
                            <Typography variant='h6'>Third Person</Typography>
                            <Typography variant='body1'>They are not strong</Typography>
                            <Typography variant='body1'>Ned hafalmen yen</Typography>
                        </Grid>
                    </Grid>
                </Container>
                <Container className='tukren-numbers' >
                    <Typography mb={2} variant='h2'>Numbers</Typography>
                    <NumberTable />
                </Container>
                <Container className='tukren-dictionary' style={{ marginTop: '2rem' }}>
                    <Typography mb={2} variant='h2'>Dictionary</Typography>
                    {dictionary && (
