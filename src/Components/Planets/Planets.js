...
const Planets = () => {
    ...
    return (
        <Container>
            ...
            <Typography variant="body1">Only 6 of the 11 planets have been discovered by the inhabitants of Maalima. Each culture has its own names and beliefs around these planets.</Typography>
                ...
                <Table size='small'>
                    ...
                    <TableBody>
                        ...
                        <TableRow className='bbottom btop'>
                            ...
                            <TableCell className='bleft' align='center'>Lis Nocātek</TableCell>
                            <TableCell className='bleft bright' align='center'>-</TableCell>
                        </TableRow>
                        <TableRow className='bbottom btop'>
            ...
            <Stage style={{ backgroundColor: 'black', overflow: 'hidden' }} width={screenWidth} height={screenHeight}>
                <Layer>
                    {/* Sun // Amondi-6 */}
                    <Circle x={screenWidth / 2} y={(screenHeight / 2)} radius={50} fill="yellow" />
                    {/* Amondi-6c //  Halir */}
                    <Circle ref={halir} x={(screenWidth / 2) - 19} y={screenHeight / 2} distance={94} year={0.08} radius={4} fill="brown" />
                    {/* Amondi-6d // Hibakhla */}
                    <Circle ref={hibakhla} x={(screenWidth / 2) - 38} y={screenHeight / 2} distance={113} year={0.23} radius={7} fill="brown" />
                    {/* Amondi-6e // Hihaihli */}
                    ...
                    {/* Amondi-6f // Himuta */}
                    <Circle ref={himuta} x={(screenWidth / 2) - 167} y={screenHeight / 2} distance={242} year={2.16} radius={10} fill="red" />
